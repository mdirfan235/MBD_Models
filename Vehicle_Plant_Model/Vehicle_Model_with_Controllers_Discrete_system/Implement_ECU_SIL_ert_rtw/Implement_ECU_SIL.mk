###########################################################################
## Makefile generated for component 'Implement_ECU_SIL'. 
## 
## Makefile     : Implement_ECU_SIL.mk
## Generated on : Sat Aug 01 18:16:01 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Implement_ECU_SIL.exe
...
PRODUCT_NAME              = Implement_ECU_SIL
MAKEFILE                  = Implement_ECU_SIL.mk
...
COMPILER_COMMAND_FILE     = Implement_ECU_SIL_comp.rsp
CMD_FILE                  = Implement_ECU_SIL.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Implement_ECU_SIL.exe
...
DEFINES_STANDARD = -DMODEL=Implement_ECU_SIL -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/Implement_ECU_SIL_ert_rtw/Implement_ECU_SIL.c $(START_DIR)/Implement_ECU_SIL_ert_rtw/Implement_ECU_SIL_data.c

MAIN_SRC = $(START_DIR)/Implement_ECU_SIL_ert_rtw/ert_main.c
...
OBJS = Implement_ECU_SIL.obj Implement_ECU_SIL_data.obj
...
%.obj : $(START_DIR)/Implement_ECU_SIL_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Implement_ECU_SIL_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Implement_ECU_SIL_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Implement_ECU_SIL_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Implement_ECU_SIL_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Implement_ECU_SIL.obj : $(START_DIR)/Implement_ECU_SIL_ert_rtw/Implement_ECU_SIL.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Implement_ECU_SIL_data.obj : $(START_DIR)/Implement_ECU_SIL_ert_rtw/Implement_ECU_SIL_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.obj : $(START_DIR)/Implement_ECU_SIL_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
