###########################################################################
## Makefile generated for component 'Powertrain_ECU_SIL'. 
## 
## Makefile     : Powertrain_ECU_SIL.mk
## Generated on : Sat Aug 01 19:07:34 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Powertrain_ECU_SIL.exe
...
PRODUCT_NAME              = Powertrain_ECU_SIL
MAKEFILE                  = Powertrain_ECU_SIL.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2026a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2026a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/irfan/OneDrive/DOCUME~1/MATLAB/VEHICL~1/WORKIN~1/SIL
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = Powertrain_ECU_SIL_comp.rsp
CMD_FILE                  = Powertrain_ECU_SIL.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Powertrain_ECU_SIL.exe
...
DEFINES_STANDARD = -DMODEL=Powertrain_ECU_SIL -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/Powertrain_ECU_SIL_ert_rtw/Powertrain_ECU_SIL.c $(START_DIR)/Powertrain_ECU_SIL_ert_rtw/rtGetInf.c $(START_DIR)/Powertrain_ECU_SIL_ert_rtw/rt_nonfinite.c

MAIN_SRC = $(START_DIR)/Powertrain_ECU_SIL_ert_rtw/ert_main.c
...
OBJS = Powertrain_ECU_SIL.obj rtGetInf.obj rt_nonfinite.obj
...
%.obj : $(START_DIR)/Powertrain_ECU_SIL_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Powertrain_ECU_SIL_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Powertrain_ECU_SIL_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Powertrain_ECU_SIL_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Powertrain_ECU_SIL_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Powertrain_ECU_SIL.obj : $(START_DIR)/Powertrain_ECU_SIL_ert_rtw/Powertrain_ECU_SIL.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.obj : $(START_DIR)/Powertrain_ECU_SIL_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/Powertrain_ECU_SIL_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/Powertrain_ECU_SIL_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
