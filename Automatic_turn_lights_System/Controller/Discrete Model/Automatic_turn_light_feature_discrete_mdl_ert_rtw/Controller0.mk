...
## Generated on : Sun Jul 05 16:35:29 2026
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Controller0.exe
...
DEFINES_STANDARD = -DMODEL=Controller0 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/Controller0_ert_rtw/Controller0.c $(START_DIR)/Controller0_ert_rtw/rt_zcfcn.c

MAIN_SRC = $(START_DIR)/Controller0_ert_rtw/ert_main.c
...
OBJS = Controller0.obj rt_zcfcn.obj
...
%.obj : $(START_DIR)/Controller0_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Controller0_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Controller0_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Controller0_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Controller0_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Controller0.obj : $(START_DIR)/Controller0_ert_rtw/Controller0.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.obj : $(START_DIR)/Controller0_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_zcfcn.obj : $(START_DIR)/Controller0_ert_rtw/rt_zcfcn.c
	$(CC) $(CFLAGS) -o "$@" "$<"
