 ...
 *
 * SIL generated interface for code: "Controller0"
 *
 */
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(Controller0_U.Steering_position_V);
        ...
        {
          void * dataAddress = (void *) &(Controller0_U.Wheelspeed);
        ...
        {
          void * dataAddress = (void *) &(Controller0_U.Brake_posn_V);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
...
XIL_INTERFACE_ERROR_CODE xilTerminate(uint32_T xilFcnId)
{
  ...
  /* Matfile logging */
  rt_StopDataLogging(MATFILE, Controller0_M->rtwLogInfo);
  Controller0_terminate();
  return XIL_INTERFACE_SUCCESS;
}
