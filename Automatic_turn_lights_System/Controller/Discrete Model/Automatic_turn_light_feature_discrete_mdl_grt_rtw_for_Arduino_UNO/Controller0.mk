...
## Generated on : Sun Jul 05 16:07:41 2026
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/Controller0_grt_rtw/Controller0.c $(START_DIR)/Controller0_grt_rtw/Controller0_data.c $(START_DIR)/Controller0_grt_rtw/rt_nonfinite.c
...
OBJS = rt_logging.obj Controller0.obj Controller0_data.obj rt_nonfinite.obj
...
%.obj : $(START_DIR)/Controller0_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Controller0_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Controller0_grt_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Controller0_grt_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Controller0_grt_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Controller0.obj : $(START_DIR)/Controller0_grt_rtw/Controller0.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Controller0_data.obj : $(START_DIR)/Controller0_grt_rtw/Controller0_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/Controller0_grt_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
